...
async function POST(request) {
    try {
        ...
        const { data: lojaData, error: lojaError } = await supabaseAdmin.from('lojas').insert([
            {
                name: nomeLoja,
                slug: slug,
                ativo: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3445a737._.js.map